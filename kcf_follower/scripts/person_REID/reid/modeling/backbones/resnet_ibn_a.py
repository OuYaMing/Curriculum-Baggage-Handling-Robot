...
__all__ = [u'ResNet_IBN', u'resnet50_ibn_a', u'resnet101_ibn_a',
           u'resnet152_ibn_a']


model_urls = {
    u'resnet50': u'https://download.pytorch.org/models/resnet50-19c8e357.pth',
    u'resnet101': u'https://download.pytorch.org/models/resnet101-5d3b4d8f.pth',
    u'resnet152': u'https://download.pytorch.org/models/resnet152-b121ed2d.pth',
}
